                    ...
                    <tbody>
                        <c:forEach var="p" items="${prenotazioni}">
                            <tr>
                                ...
                                <td>${p.clienteNome} ${p.clienteCognome}<br><span class="text-cf">${p.clienteCF}</span></td>
                                <td>
                                    <form action="${pageContext.request.contextPath}/admin/prenotazioni" method="post" class="form-inline-block">
                        ...
                        <c:if test="${empty prenotazioni}">
                            <tr>
                                <td colspan="5" class="text-empty-table">Nessuna prenotazione trovata.</td>
                            </tr>
                        </c:if>
                    </tbody>
                </table>
