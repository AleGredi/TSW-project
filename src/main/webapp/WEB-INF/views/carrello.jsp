        ...
        <c:choose>
            <c:when test="${empty sessionScope.carrello or empty sessionScope.carrello.righe}">
                <div class="empty-cart">
                    <h2 class="uppercase">Il tuo carrello è vuoto</h2>
            ...
            <c:otherwise>
                ...
                <div class="error-message bg-error-text-white-p-10-rounded-8-mb-20">
                ...
                <tbody>
                    <c:forEach var="riga" items="${sessionScope.carrello.righe}">
                        <tr>
                            ...
                            <td>
                                <div class="d-flex-align-items-center-justify-content-center-g">
                                    <button class="btn-outline p-2-8-min-width-auto-height-30" onclick="aggiornaQuantita('${riga.idProdotto}', '${riga.tipo}', ${riga.quantita}, -1)">-</button>
                                    <span class="fw-bold-w-20-text-center">${riga.quantita}</span>
                                    <button class="btn-outline p-2-8-min-width-auto-height-30" onclick="aggiornaQuantita('${riga.idProdotto}', '${riga.tipo}', ${riga.quantita}, 1)">+</button>
                                </div>
                            </td>
            ...
            <div class="cart-summary">
                ...
                <form action="${pageContext.request.contextPath}/checkout" method="get" class="m-0">
