...
<body>
    ...
    <main class="catalogo-container">
            ...
            <div class="search-container">
                ...
                <form id="search-form" action="${pageContext.request.contextPath}/catalogo" method="get">
                <input type="text" id="search-input" name="q" value="${param.q}" placeholder="Cerca per modello, marca o calibro...">
        ...
        <section class="catalogo-section">
            ...
            <div class="cards-grid" id="armi-grid">
                <c:choose>
        ...
        <section class="catalogo-section">
            <h2>MUNIZIONI</h2>
            <div class="cards-grid" id="munizioni-grid">
                <c:choose>
