    ...
    <section class="hero">
        <c:choose>
            <c:when test="${not empty sessionScope.utente}">
                ...
                <p class="hero-subtitle">Esplora il catalogo esclusivo per te che sei <strong class="text-accent">${sessionScope.utente.tipoCliente}</strong>.</p>
            ...
            <c:otherwise>
                ...
                <p class="hero-subtitle">La tua passione per il tiro a volo, con la qualità di sempre.</p>
                <div class="hero-buttons">
                    <a href="${pageContext.request.contextPath}/registrazione" class="btn-hero">Diventa Socio</a>
                    <a href="${pageContext.request.contextPath}/catalogo" class="btn-hero-outline">Esplora Catalogo</a>
                </div>
            </c:otherwise>
        </c:choose>
    </section>
    ...
    <section class="about-section">
        ...
        <div class="about-grid">
            <div class="feature-box">
                <h4>🕒 Prenotazioni H24</h4>
                <p>Il nostro sistema è sempre online. Assicurati il tuo slot preferito in pedana in qualsiasi momento, senza dover aspettare gli orari di apertura della segreteria.</p>
            </div>
            <div class="feature-box">
                <h4>🏆 Strutture Professionali</h4>
                <p>Campi omologati per Fossa Olimpica e Skeet. Macchine lanciapiattelli di ultima generazione, manutenute con cura per garantirti un'esperienza di tiro perfetta.</p>
            </div>
            <div class="feature-box">
                <h4>🤝 La Nostra Community</h4>
                <p>Unisciti ai nostri Soci! Accedi al noleggio di armi esclusive, partecipa alle gare ufficiali del circolo, scala le classifiche e vivi a pieno la competizione.</p>
            </div>
        </div>
    </section>
